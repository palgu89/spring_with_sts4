				...
				<div class="row g-3">
					...
					<div class="col-12">
						...
						<div class="input-group has-validation">
							...
							<input type="email" class="form-control" name="writer" id="writer" value="${bvo.writer }" readOnly>
						</div>
					</div>

					<div class="col-12">
						<label for="regAt" class="form-label">Reg At</label> <input
							type="text" class="form-control" value="${bvo.regAt }" readOnly>
					</div>

					<div class="col-12">
						<label for="modAt" class="form-label">Mod At</label> <input
							type="text" class="form-control" value="${bvo.modAt }" readOnly>
					</div>
					...
					<div class="col-12">
						...
						<input type="text" class="form-control" name="title" id="title" value="${bvo.title }" readOnly>
					</div>

					<div class="col-12">
						<label for="cont" class="form-label">Content</label>
						<textarea class="form-control" name="content" id="cont" placeholder="Content" readOnly>${bvo.content }</textarea>
					</div>
					<div class="col-4">
						<a href="/board/list?pageNo=${pgvo.pageNo }&qty=${pgvo.qty}" class="btn btn-primary">LIST</a>
					</div>
					<div class="col-4">
						<a href="/board/modify?bno=${bvo.bno }&pageNo=${pgvo.pageNo }&qty=${pgvo.qty}" id="modBtn" class="btn btn-outline-warning">MOD</a>
					</div>
					<div class="col-4">
