...
@MapperScan(basePackages = {"com.myweb.www.repository"})	// 얘를 만들면 DAOImpl을 하지 않아도 됨 > DAO - mapper 동기화
public class RootConfig {
	...
	public SqlSessionFactory sqlSessionFactory() throws Exception {
		...
		sqlFactoryBean.setMapperLocations(applicationContext.getResources("classpath:/mappers/*.xml"));	// 그리고 얘로 인해 DAO와 mapper의 이름들이 동일해짐
		// 위의 애는 배열형으로 복수로 처리하기 때문에 getResources 
